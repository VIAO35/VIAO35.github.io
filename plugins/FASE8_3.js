(function() {
  ...
  var plugin = {
    ...
    css: `
      ...
      #mod-fase8-3 .formula-box { background: #334155; border-radius: 8px; padding: 12px; margin: 12px 0; font-family: monospace; font-size: 13px; color: #94a3b8; text-align: center; }
