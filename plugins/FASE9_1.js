(function() {
  ...
  var plugin = {
    ...
    css: `
      #mod-fase9_1 .cliente-card { background: #1e293b; border: 1px solid #334155; border-radius: 12px; padding: 16px; margin-bottom: 12px; }
      #mod-fase9_1 .cliente-header { display: flex; align-items: center; gap: 12px; margin-bottom: 12px; }
      #mod-fase9_1 .cliente-avatar { width: 48px; height: 48px; border-radius: 50%; background: #3b82f6; display: flex; align-items: center; justify-content: center; font-size: 20px; color: #fff; }
      #mod-fase9_1 .cliente-avatar.persona { background: #10b981; }
      #mod-fase9_1 .cliente-avatar.empresa { background: #3b82f6; }
      #mod-fase9_1 .cliente-avatar.mayorista { background: #f59e0b; }
      #mod-fase9_1 .cliente-info { flex: 1; }
      #mod-fase9_1 .cliente-nombre { font-size: 16px; font-weight: 600; color: #f1f5f9; }
      #mod-fase9_1 .cliente-rif { font-size: 12px; color: #94a3b8; }
      #mod-fase9_1 .credito-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; }
      #mod-fase9_1 .credito-item { text-align: center; padding: 8px; border-radius: 6px; background: #334155; }
      #mod-fase9_1 .credito-moneda { font-size: 11px; color: #94a3b8; }
      #mod-fase9_1 .credito-monto { font-size: 14px; font-weight: 600; color: #f1f5f9; }
      #mod-fase9_1 .modal-form-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 16px; }
      #mod-fase9_1 .tipo-badge { display: inline-block; padding: 3px 10px; border-radius: 4px; font-size: 11px; font-weight: 500; margin-left: 8px; }
      #mod-fase9_1 .tipo-empresa { background: rgba(59,130,246,0.15); color: #3b82f6; }
      #mod-fase9_1 .tipo-persona { background: rgba(16,185,129,0.15); color: #10b981; }
      #mod-fase9_1 .tipo-mayorista { background: rgba(245,158,11,0.15); color: #f59e0b; }
      #mod-fase9_1 .tipo-minorista { background: rgba(139,92,246,0.15); color: #8b5cf6; }
      #mod-fase9_1 .tipo-distribuidor { background: rgba(236,72,153,0.15); color: #ec4899; }
    `,
