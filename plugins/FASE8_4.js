(function() {
  ...
  var plugin = {
    ...
    css: `
      #mod-fase8_4 .precio-row { display: flex; align-items: center; gap: 12px; padding: 10px; border-radius: 8px; background: #334155; margin-bottom: 8px; }
      #mod-fase8_4 .precio-label { font-size: 13px; color: #94a3b8; min-width: 120px; }
      #mod-fase8_4 .precio-value { font-size: 16px; font-weight: 600; color: #f1f5f9; flex: 1; }
    `,
