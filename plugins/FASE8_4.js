// ═══════════════════════════════════════════════════════════════════════════════
// FASE 8.4 - PRECIOS MULTI-MONEDA (Micro-fase anidada)
// Precios en VES/USD/EUR para materias primas.
// Dependencia: FASE8_3
// Compatible con ERP Core v3.0 - Slots API
// Se inyecta en tab "saldos" del modulo padre fase8
// ═══════════════════════════════════════════════════════════════════════════════
...
(function() {
  ...
  var DEPENDENCIAS    = ["FASE1_10", "FASE8_1", "FASE8_2", "FASE8_3"];
  ...
  function renderTable() {
    ...
    _erp.updateKPI(PARENT_MODULE, "saldo-ves", _erp.formatearMoneda(totalVES, "VES"), "Bolivares");
    _erp.updateKPI(PARENT_MODULE, "saldo-usd", _erp.formatearMoneda(totalUSD, "USD"), "Dolares");
    _erp.updateKPI(PARENT_MODULE, "saldo-eur", _erp.formatearMoneda(totalEUR, "EUR"), "Euros");
  }
