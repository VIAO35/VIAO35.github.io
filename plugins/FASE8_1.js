(function() {
  ...
  var plugin = {
    ...
    css: `
      #mod-fase8-1 .moneda-card { background: #1e293b; border: 1px solid #334155; border-radius: 12px; padding: 20px; text-align: center; transition: .2s; }
      #mod-fase8-1 .moneda-card:hover { border-color: #3b82f6; transform: translateY(-2px); }
      #mod-fase8-1 .moneda-simbolo { font-size: 36px; font-weight: 700; color: #3b82f6; margin-bottom: 8px; }
      #mod-fase8-1 .moneda-nombre { font-size: 14px; font-weight: 600; color: #f1f5f9; }
      #mod-fase8-1 .moneda-codigo { font-size: 12px; color: #94a3b8; margin-top: 4px; }
      #mod-fase8-1 .moneda-base { display: inline-block; padding: 3px 10px; border-radius: 4px; font-size: 11px; font-weight: 500; background: rgba(16,185,129,0.15); color: #10b981; margin-top: 8px; }
    `,
